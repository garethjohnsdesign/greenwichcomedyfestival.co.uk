!function t(e,n){"object"==typeof exports&&"object"==typeof module?module.exports=n():"function"==typeof define&&define.amd?define([],n):"object"==typeof exports?exports.Swup=n():e.Swup=n()}(window,function(){/******/
return function(n){
/******/
...
/**
         ...
         */
this.getUrl=T.default,this.cache=new c.default,this.link=new f.default,this.transitionEndEvent=(0,p.default)(),this.getDataFromHtml=y.default,this.getPage=g.default,this.scrollTo=E.default,this.loadPage=w.default,this.renderPage=_.default,this.createState=x.default,this.triggerEvent=C.default,this.classify=A.default,this.doScrolling=L.default,this.markSwupElements=M.default,this.on=H.default,this.off=I.default,this.updateTransition=F.default,this.preloadPage=W.default,this.preloadPages=U.default,this.usePlugin=Q.default,this.log=V.default,this.enable=this.enable,this.destroy=this.destroy,
...
/******/])}),function t(e,n){"object"==typeof exports&&"object"==typeof module?module.exports=n():"function"==typeof define&&define.amd?define([],n):"object"==typeof exports?exports.swupGaPlugin=n():e.swupGaPlugin=n()}(window,function(){/******/
return function(n){
/******/
/******/ // The require function
/******/function o(t){
...
/******/([
/* 0 */
/***/function(t,e,n){"use strict";t.exports={name:"swupGaPlugin",options:{runScripts:!1},exec:function t(e,n){document.addEventListener("swup:contentReplaced",function(){if("function"==typeof window.ga){var t=document.title,e=window.location.pathname+window.location.search;window.ga("set","title",t),window.ga("set","page",e),window.ga("send","pageview"),n.log("GA pageview (url '"+e+"').")}else console.warn("GA is not loaded.")})}}}
/******/])}),
/*!
...
function e(t,n,i){return yt(n)?_t.grep(t,function(t,e){return!!n.call(t,e,t)!==i}):
// Single element
n.nodeType?_t.grep(t,function(t){return t===n!==i}):
// Arraylike of elements (jQuery, arguments, Array)
"string"!=typeof n?_t.grep(t,function(t){return-1<dt.call(n,t)!==i}):_t.filter(n,t,i)}function n(t,e){for(;(t=t[e])&&1!==t.nodeType;);return t}
// Convert String-formatted options into Object-formatted ones
function c(t){var n={};return _t.each(t.match(Lt)||[],function(t,e){n[e]=!0}),n}
/*
...
function i(){st.removeEventListener("DOMContentLoaded",i),j.removeEventListener("load",i),_t.ready()}
...
function h(t){return t.replace(Ht,"ms-").replace(Rt,o)}function r(){this.expando=_t.expando+r.uid++}function s(t){return"true"===t||"false"!==t&&("null"===t?null:
...
Ft.set(t,e,n)}else n=void 0;return n}function v(t,e,n,i){var o,r,s=20,a=i?function(){return i.cur()}:function(){return _t.css(t,e,"")},l=a(),u=n&&n[3]||(_t.cssNumber[e]?"":"px"),
// Starting value computation is required for potential unit mismatches
c=(_t.cssNumber[e]||"px"!==u&&+l)&&Ut.exec(_t.css(t,e));if(c&&c[3]!==u){for(
// Support: Firefox <=54
...
_t.style(t,e,c+u),(1-r)*(1-(r=a()/l||.5))<=0&&(s=0),c/=r;c*=2,_t.style(t,e,c+u),
// Make sure we update the tween properties later on
n=n||[]}return n&&(c=+c||+l||0,
// Apply relative offset (+=/-=) if specified
o=n[1]?c+(n[1]+1)*n[2]:+n[2],i&&(i.unit=u,i.start=c,i.end=o)),o}function y(t){var e,n=t.ownerDocument,i=t.nodeName,o=Vt[i];return o||(e=n.body.appendChild(n.createElement(i)),o=_t.css(e,"display"),e.parentNode.removeChild(e),"none"===o&&(o="block"),Vt[i]=o)}function b(t,e){
// Determine new display value for elements that need to change
for(var n,i,o=[],r=0,s=t.length;r<s;r++)(i=t[r]).style&&(n=i.style.display,e?(
// Since we force visibility upon cascade-hidden elements, an immediate (and slow)
// check is required in this first loop unless we have a nonempty display value (either
// inline or about-to-be-restored)
"none"===n&&(o[r]=Nt.get(i,"display")||null,o[r]||(i.style.display="")),""===i.style.display&&Qt(i)&&(o[r]=y(i))):"none"!==n&&(o[r]="none",
...
var n;return n=void 0!==t.getElementsByTagName?t.getElementsByTagName(e||"*"):void 0!==t.querySelectorAll?t.querySelectorAll(e||"*"):[],void 0===e||e&&u(t,e)?_t.merge([t],n):n}
// Mark scripts as having already been evaluated
function k(t,e){for(var n=0,i=t.length;n<i;n++)Nt.set(t[n],"globalEval",!e||Nt.get(e[n],"globalEval"))}function _(t,e,n,i,o){for(var r,s,a,l,u,c,d=e.createDocumentFragment(),f=[],h=0,p=t.length;h<p;h++)if((r=t[h])||0===r)
// Add nodes directly
if("object"===g(r))
// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
_t.merge(f,r.nodeType?[r]:r);
// Convert non-html into a text node
else if(ee.test(r)){for(s=s||d.appendChild(e.createElement("div")),
// Deserialize a standard representation
a=(Zt.exec(r)||["",""])[1].toLowerCase(),l=te[a]||te._default,s.innerHTML=l[1]+_t.htmlPrefilter(r)+l[2],
// Descend through wrappers to the right content
c=l[0];c--;)s=s.lastChild;
// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
_t.merge(f,s.childNodes),
...
if(i&&-1<_t.inArray(r,i))o&&o.push(r);else
// Capture executables
if(u=_t.contains(r.ownerDocument,r),
// Append to fragment
s=w(d.appendChild(r),"script"),
// Preserve script evaluation history
u&&k(s),n)for(c=0;r=s[c++];)Jt.test(r.type||"")&&n.push(r);return d}function x(){return!0}function $(){return!1}
// Support: IE <=9 only
...
o=i,i=void 0):(
// ( types, data, fn )
o=i,i=n,n=void 0)),!1===o)o=$;else if(!o)return t;return 1===r&&(s=o,
// Use same guid so caller can remove using origFn
(o=function(t){
// Can use an empty set, since event contains the info
return _t().off(t),s.apply(this,arguments)}).guid=s.guid||(s.guid=_t.guid++)),t.each(function(){_t.event.add(this,e,o,i,n)})}
/*
 * Helper functions for managing events -- not part of the public interface.
 * Props to Dean Edwards' addEvent library for many of the ideas.
 */
// Prefer a tbody over its parent table for containing new rows
function T(t,e){return u(t,"table")&&u(11!==e.nodeType?e:e.firstChild,"tr")&&_t(t).children("tbody")[0]||t}
...
if(Nt.hasData(t)&&(r=Nt.access(t),s=Nt.set(e,r),u=r.events))for(o in delete s.handle,s.events={},u)for(n=0,i=u[o].length;n<i;n++)_t.event.add(e,o,u[o][n]);
// 2. Copy user data
Ft.hasData(t)&&(a=Ft.access(t),l=_t.extend({},a),Ft.set(e,l))}}
...
if(p||1<d&&"string"==typeof h&&!vt.checkClone&&de.test(h))return n.each(function(t){var e=n.eq(t);p&&(i[0]=h.call(this,t,e.html())),P(e,i,o,r)});if(d&&(e=(t=_(i,n[0].ownerDocument,!1,n,r)).firstChild,1===t.childNodes.length&&(t=e),e||r)){
// Use the original fragment for the last item
// instead of the first because it can end up
// being emptied incorrectly in certain situations (#8070).
for(a=(s=_t.map(w(t,"script"),S)).length;c<d;c++)l=t,c!==f&&(l=_t.clone(l,!0,!0),
// Keep references to cloned scripts for later restoration
a&&
// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
_t.merge(s,w(l,"script"))),o.call(n[c],l,c);if(a)
// Evaluate executable scripts on first document insertion
for(u=s[s.length-1].ownerDocument,
// Reenable scripts
_t.map(s,E),c=0;c<a;c++)l=s[c],Jt.test(l.type||"")&&!Nt.access(l,"globalEval")&&_t.contains(u,l)&&(l.src&&"module"!==(l.type||"").toLowerCase()?
// Optional AJAX dependency, but won't run scripts if not present
_t._evalUrl&&_t._evalUrl(l.src):m(l.textContent.replace(fe,""),u,l))}return n}function L(t,e,n){for(var i,o=e?_t.filter(e,t):t,r=0;null!=(i=o[r]);r++)n||1!==i.nodeType||_t.cleanData(w(i)),i.parentNode&&(n&&_t.contains(i.ownerDocument,i)&&k(w(i,"script")),i.parentNode.removeChild(i));return t}function D(t,e,n){var i,o,r,s,
// Support: Firefox 51+
...
return(n=n||pe(t))&&(""!==(s=n.getPropertyValue(e)||n[e])||_t.contains(t.ownerDocument,t)||(s=_t.style(t,e)),
...
function H(t){var e=_t.cssProps[t];return e||(e=_t.cssProps[t]=q(t)||t),e}function R(t,e,n){
...
"margin"===n&&(l+=_t.css(t,n+Kt[s],!0,o)),
// If we get here with a content-box, we're seeking "padding" or "border" or "margin"
i?(
// For "content", subtract padding
"content"===n&&(l-=_t.css(t,"padding"+Kt[s],!0,o)),
// For "content" or "padding", subtract border
"margin"!==n&&(l-=_t.css(t,"border"+Kt[s]+"Width",!0,o))):(
// Add padding
l+=_t.css(t,"padding"+Kt[s],!0,o),
// For "border" or "margin", add border
"padding"!==n?l+=_t.css(t,"border"+Kt[s]+"Width",!0,o):a+=_t.css(t,"border"+Kt[s]+"Width",!0,o));
...
var i=pe(t),o=D(t,e,i),r="border-box"===_t.css(t,"boxSizing",!1,i),s=r;
// Support: Firefox <=54
...
("auto"===o||!parseFloat(o)&&"inline"===_t.css(t,"display",!1,i))&&(o=t["offset"+e[0].toUpperCase()+e.slice(1)],
// offsetWidth/offsetHeight provide border-box values
s=!0),(
// Normalize "" and auto
o=parseFloat(o)||0)+I(t,e,n||(r?"border":"content"),s,i,
// Provide the current computed size to request scroll gutter calculation (gh-3589)
o)+"px"}function F(t,e,n,i,o){return new F.prototype.init(t,e,n,i,o)}function B(){je&&(!1===st.hidden&&j.requestAnimationFrame?j.requestAnimationFrame(B):j.setTimeout(B,_t.fx.interval),_t.fx.tick())}
// Animations created synchronously will run synchronously
function W(){return j.setTimeout(function(){_e=void 0}),_e=Date.now()}
// Generate parameters to create a standard animation
function G(t,e){var n,i=0,o={height:t};
// If we include width, step value is 1 to do all cssExpand values,
// otherwise step value is 2 to skip over Left and Right
for(e=e?1:0;i<4;i+=2-e)o["margin"+(n=Kt[i])]=o["padding"+n]=t;return e&&(o.opacity=o.width=t),o}function U(t,e,n){for(var i,o=(Y.tweeners[e]||[]).concat(Y.tweeners["*"]),r=0,s=o.length;r<s;r++)if(i=o[r].call(n,e,t))
// We're done with this property
return i}function K(t,e,n){var i,o,r,s,a,l,u,c,d="width"in e||"height"in e,f=this,h={},p=t.style,m=t.nodeType&&Qt(t),g=Nt.get(t,"fxshow");
// Queue-skipping animations hijack the fx hooks
// Detect show/hide animations
for(i in n.queue||(null==(s=_t._queueHooks(t,"fx")).unqueued&&(s.unqueued=0,a=s.empty.fire,s.empty.fire=function(){s.unqueued||a()}),s.unqueued++,f.always(function(){
// Ensure the complete handler is called before this completes
f.always(function(){s.unqueued--,_t.queue(t,"fx").length||s.empty.fire()})})),e)if(o=e[i],xe.test(o)){if(delete e[i],r=r||"toggle"===o,o===(m?"hide":"show")){
// Pretend to be hidden if this is a "show" and
// there is still data from a stopped show/hide
if("show"!==o||!g||void 0===g[i])continue;m=!0}h[i]=g&&g[i]||_t.style(t,i)}
// Bail out if this is a no-op like .hide().hide()
if((l=!_t.isEmptyObject(e))||!_t.isEmptyObject(h))for(i in
...
u=g&&g.display)&&(u=Nt.get(t,"display")),"none"===(c=_t.css(t,"display"))&&(u?c=u:(
// Get nonempty value(s) by temporarily forcing visibility
b([t],!0),u=t.style.display||u,c=_t.css(t,"display"),b([t]))),
// Animate inline elements as inline-block
("inline"===c||"inline-block"===c&&null!=u)&&"none"===_t.css(t,"float")&&(
...
m||b([t]),Nt.remove(t,"fxshow"),h)_t.style(t,i,h[i])})),
// Per-property setup
l=U(m?g[i]:0,i,f),i in g||(g[i]=l.start,m&&(l.end=l.start,l.start=0))}function Q(t,e){var n,i,o,r,s;
// camelCase, specialEasing and expand cssHook pass
for(n in t)if(o=e[i=h(n)],r=t[n],Array.isArray(r)&&(o=r[1],r=t[n]=r[0]),n!==i&&(t[i]=r,delete t[n]),(s=_t.cssHooks[i])&&"expand"in s)
// Not quite $.extend, this won't overwrite existing keys.
// Reusing 'index' because we have the correct "name"
for(n in r=s.expand(r),delete t[i],r)n in t||(t[n]=r[n],e[n]=o);else e[i]=o}function Y(s,t,e){var n,a,i=0,o=Y.prefilters.length,l=_t.Deferred().always(function(){
// Don't match elem in the :animated selector
delete r.elem}),r=function(){if(a)return!1;for(var t=_e||W(),e=Math.max(0,u.startTime+u.duration-t),
...
l.resolveWith(s,[u]),!1)},u=l.promise({elem:s,props:_t.extend({},t),opts:_t.extend(!0,{specialEasing:{},easing:_t.easing._default},e),originalProperties:t,originalOptions:e,startTime:_e||W(),duration:e.duration,tweens:[],createTween:function(t,e){var n=_t.Tween(s,u.opts,t,e,u.opts.specialEasing[t]||u.opts.easing);return u.tweens.push(n),n},stop:function(t){var e=0,
// If we are going to the end, we want to run all the tweens
// otherwise we skip this part
n=t?u.tweens.length:0;if(a)return this;for(a=!0;e<n;e++)u.tweens[e].run(1);
// Resolve when we played the last frame; otherwise, reject
return t?(l.notifyWith(s,[u,1,0]),l.resolveWith(s,[u,t])):l.rejectWith(s,[u,t]),this}}),c=u.props;for(Q(c,u.opts.specialEasing);i<o;i++)if(n=Y.prefilters[i].call(u,s,c,u.opts))return yt(n.stop)&&(_t._queueHooks(u.elem,u.opts.queue).stop=n.stop.bind(n)),n;return _t.map(c,U,u),yt(u.opts.start)&&u.opts.start.call(s,u),
// Attach callbacks from options
u.progress(u.opts.progress).done(u.opts.done,u.opts.complete).fail(u.opts.fail).always(u.opts.always),_t.fx.timer(_t.extend(r,{elem:s,anim:u,queue:u.opts.queue})),u}
...
_t.each(t,function(t,e){i||Re.test(n)?
...
function et(e,o,r,s){function a(t){var i;return l[t]=!0,_t.each(e[t]||[],function(t,e){var n=e(o,r,s);return"string"!=typeof n||u||l[n]?u?!(i=n):void 0:(o.dataTypes.unshift(n),a(n),!1)}),i}var l={},u=e===Xe;return a(o.dataTypes[0])||!l["*"]&&a("*")}
// A special extend for ajax options
// that takes "flat" options (not to be deep extended)
// Fixes #9887
function nt(t,e){var n,i,o=_t.ajaxSettings.flatOptions||{};for(n in e)void 0!==e[n]&&((o[n]?t:i||(i={}))[n]=e[n]);return i&&_t.extend(!0,t,i),t}
...
jt=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;_t.fn=_t.prototype={
// The current version of jQuery being used
jquery:kt,constructor:_t,
...
c&&o&&(_t.isPlainObject(o)||(r=Array.isArray(o)))?(s=r?(r=!1,i&&Array.isArray(i)?i:[]):i&&_t.isPlainObject(i)?i:{},
// Never move original objects, clone them
a[n]=_t.extend(c,s,o)):void 0!==o&&(a[n]=o));
...
// Support: Android <=4.0 only
trim:function(t){return null==t?"":(t+"").replace(jt,"")},
// results is for internal usage only
makeArray:function(t,e){var n=e||[];return null!=t&&(a(Object(t))?_t.merge(n,"string"==typeof t?[t]:t):ct.call(n,t)),n},inArray:function(t,e,n){return null==e?-1:dt.call(e,t,n)},
// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
...
support:vt}),"function"==typeof Symbol&&(_t.fn[Symbol.iterator]=rt[Symbol.iterator]),
// Populate the class2type map
_t.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(t,e){ft["[object "+e+"]"]=e.toLowerCase()});var xt=
/*!
...
// Class selector
if((o=l[3])&&_.getElementsByClassName&&e.getElementsByClassName)return Z.apply(n,e.getElementsByClassName(o)),n}
// Take advantage of querySelectorAll
if(_.qsa&&!U[t+" "]&&(!M||!M.test(t))){if(1!==f)d=e,c=t;else if("object"!==e.nodeName.toLowerCase()){for(
// Capture the context ID, setting it first if necessary
(a=e.getAttribute("id"))?a=a.replace(kt,_t):e.setAttribute("id",a=I),r=(
// Prefix every selector in the list
u=C(t)).length;r--;)u[r]="#"+a+" "+p(u[r]);c=u.join(","),
// Expand context for sibling selectors
d=yt.test(t)&&h(e.parentNode)||e}if(c)try{return Z.apply(n,d.querySelectorAll(c)),n}catch(t){}finally{a===I&&e.removeAttribute("id")}}}
// All others
 ...
 */function e(t,e){for(var n=t.split("|"),i=n.length;i--;)j.attrHandle[n[i]]=e}
/**
...
o=(r=t[I]||(t[I]={}))[t.uniqueID]||(r[t.uniqueID]={}),u&&u===t.nodeName.toLowerCase())t=t[l]||t;else{if((i=o[c])&&i[0]===F&&i[1]===f)
...
// Apply postFilter
if(m&&m(d,f,n,i),g)for(o=k(f,l),g(o,[],n,i),
...
}else f=k(f===e?f.splice(u,f.length):f),v?v(null,e,f,i):Z.apply(e,f)})}function m(t){for(var o,e,n,i=t.length,r=j.relative[t[0].type],s=r||j.relative[" "],a=r?1:0,
...
return o=null,i}];a<i;a++)if(e=j.relative[t[a].type])c=[d(f(c),e)];else{
// Return special upon seeing a positional matcher
if((e=j.filter[t[a].type].apply(null,t[a].matches))[I]){for(
// Find the next relative operator (if any) for proper handling
n=++a;n<i&&!j.relative[t[n].type];n++);return b(1<a&&f(c),1<a&&p(
...
return o&&(F=p,S=f),c};return y?l(t):t}var v,_,j,x,$,C,O,T,S,E,z,
// Local document vars
A,P,L,D,M,q,H,R,
// Instance-specific data
I="sizzle"+1*new Date,N=n.document,F=0,B=0,W=t(),G=t(),U=t(),K=function(t,e){return t===e&&(z=!0),0},
// Instance methods
Q={}.hasOwnProperty,Y=[],V=Y.pop,X=Y.push,Z=Y.push,J=Y.slice,
...
kt=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g,_t=function(t,e){return e?
...
// error in IE
jt=function(){A()},xt=d(function(t){return!0===t.disabled&&("form"in t||"label"in t)},{dir:"parentNode",next:"legend"});
// Optimize for push.apply( _, NodeList )
try{Z.apply(Y=J.call(N.childNodes),N.childNodes),
// Support: Android<4.0
// Detect silently failing push.apply
Y[N.childNodes.length].nodeType}catch(t){Z={apply:Y.length?
...
L=(P=i).documentElement,D=!$(P),
// Support: IE 9-11, Edge
// Accessing iframe documents after unload throws "permission denied" errors (jQuery #13936)
N!==P&&(n=P.defaultView)&&n.top!==n&&(
// Support: IE 11, Edge
n.addEventListener?n.addEventListener("unload",jt,!1):n.attachEvent&&n.attachEvent("onunload",jt)),
/* Attributes
	---------------------------------------------------------------------- */
// Support: IE<8
// Verify that getAttribute really returns attributes and not properties
// (excepting IE8 booleans)
_.attributes=o(function(t){return t.className="i",!t.getAttribute("className")}),
/* getElement(s)By*
	---------------------------------------------------------------------- */
// Check if getElementsByTagName("*") returns only elements
_.getElementsByTagName=o(function(t){return t.appendChild(P.createComment("")),!t.getElementsByTagName("*").length}),
// Support: IE<9
_.getElementsByClassName=gt.test(P.getElementsByClassName),
// Support: IE<10
// Check if getElementById returns elements by name
// The broken getElementById methods don't pick up programmatically-set names,
// so use a roundabout getElementsByName test
_.getById=o(function(t){return L.appendChild(t).id=I,!P.getElementsByName||!P.getElementsByName(I).length}),
// ID filter and find
_.getById?(j.filter.ID=function(t){var e=t.replace(bt,wt);return function(t){return t.getAttribute("id")===e}},j.find.ID=function(t,e){if(void 0!==e.getElementById&&D){var n=e.getElementById(t);return n?[n]:[]}}):(j.filter.ID=function(t){var n=t.replace(bt,wt);return function(t){var e=void 0!==t.getAttributeNode&&t.getAttributeNode("id");return e&&e.value===n}},
// Support: IE 6 - 7 only
// getElementById is not reliable as a find shortcut
j.find.ID=function(t,e){if(void 0!==e.getElementById&&D){var n,i,o,r=e.getElementById(t);if(r){if((
...
// Tag
j.find.TAG=_.getElementsByTagName?function(t,e){return void 0!==e.getElementsByTagName?e.getElementsByTagName(t):_.qsa?e.querySelectorAll(t):void 0}:function(t,e){var n,i=[],o=0,
// By happy coincidence, a (broken) gEBTN appears on DocumentFragment nodes too
r=e.getElementsByTagName(t);
// Filter out possible comments
if("*"!==t)return r;for(;n=r[o++];)1===n.nodeType&&i.push(n);return i},
// Class
j.find.CLASS=_.getElementsByClassName&&function(t,e){if(void 0!==e.getElementsByClassName&&D)return e.getElementsByClassName(t)},
/* QSA/matchesSelector
	---------------------------------------------------------------------- */
...
M=[],(_.qsa=gt.test(P.querySelectorAll))&&(
// Build QSA regex
...
t.querySelectorAll("[msallowcapture^='']").length&&M.push("[*^$]="+nt+"*(?:''|\"\")"),
// Support: IE8
// Boolean attributes and "value" are not treated correctly
t.querySelectorAll("[selected]").length||M.push("\\["+nt+"*(?:value|"+et+")"),
// Support: Chrome<29, Android<4.4, Safari<7.0+, iOS<7.0+, PhantomJS<1.9.8+
t.querySelectorAll("[id~="+I+"-]").length||M.push("~="),
...
t.querySelectorAll("a#"+I+"+*").length||M.push(".#.+[+~]")}),o(function(t){t.innerHTML="<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
...
L.appendChild(t).disabled=!0,2!==t.querySelectorAll(":disabled").length&&M.push(":enabled",":disabled"),
// Opera 10-11 does not throw on post-comma invalid pseudos
t.querySelectorAll("*,:x"),M.push(",.*:")})),(_.matchesSelector=gt.test(H=L.matches||L.webkitMatchesSelector||L.mozMatchesSelector||L.oMatchesSelector||L.msMatchesSelector))&&o(function(t){
// Check to see if it's possible to do matchesSelector
// on a disconnected node (IE 9)
_.disconnectedMatch=H.call(t,"*"),
// This should fail with an exception
// Gecko does not error, returns false instead
H.call(t,"[s!='']:x"),q.push("!=",rt)}),M=M.length&&new RegExp(M.join("|")),q=q.length&&new RegExp(q.join("|")),
/* Contains
	---------------------------------------------------------------------- */
...
1)||!_.sortDetached&&e.compareDocumentPosition(t)===n?
// Choose the first element that is related to our preferred document
t===P||t.ownerDocument===N&&R(N,t)?-1:e===P||e.ownerDocument===N&&R(N,e)?1:E?tt(E,t)-tt(E,e):0:4&n?-1:1)}:function(t,e){
...
e=e.replace(ct,"='$1']"),_.matchesSelector&&D&&!U[e+" "]&&(!q||!q.test(e))&&(!M||!M.test(e)))try{var n=H.call(t,e);
...
// Set document vars if needed
(t.ownerDocument||t)!==P&&A(t);var n=j.attrHandle[e.toLowerCase()],
// Don't get fooled by Object.prototype properties (jQuery #13807)
i=n&&Q.call(j.attrHandle,e.toLowerCase())?n(t,e,!D):void 0;return void 0!==i?i:_.attributes||!D?t.getAttribute(e):(i=t.getAttributeNode(e))&&i.specified?i.value:null},w.escape=function(t){return(t+"").replace(kt,_t)},w.error=function(t){throw new Error("Syntax error, unrecognized expression: "+t)},
/**
...
if(z=!_.detectDuplicates,E=!_.sortStable&&t.slice(0),t.sort(K),z){for(;e=t[o++];)e===t[o]&&(i=n.push(o));for(;i--;)t.splice(n[i],1)}
...
var e,s=j.pseudos[t]||j.setFilters[t.toLowerCase()]||w.error("unsupported pseudo: "+t);
// The user may use createPseudo to indicate that
// arguments are needed to create the filter function
// just as Sizzle does
return s[I]?s(r):
// But maintain support for old signatures
1<s.length?(e=[t,t,"",r],j.setFilters.hasOwnProperty(t.toLowerCase())?l(function(t,e){for(var n,i=s(t,r),o=i.length;o--;)t[n=tt(t,i[o])]=!(e[n]=i[o])}):function(t){return s(t,0,e)}):s}},pseudos:{
...
for(t=t.firstChild;t;t=t.nextSibling)if(t.nodeType<6)return!1;return!0},parent:function(t){return!j.pseudos.empty(t)},
// Element/input types
...
first:a(function(){return[0]}),last:a(function(t,e){return[e-1]}),eq:a(function(t,e,n){return[n<0?n+e:n]}),even:a(function(t,e){for(var n=0;n<e;n+=2)t.push(n);return t}),odd:a(function(t,e){for(var n=1;n<e;n+=2)t.push(n);return t}),lt:a(function(t,e,n){for(var i=n<0?n+e:n;0<=--i;)t.push(i);return t}),gt:a(function(t,e,n){for(var i=n<0?n+e:n;++i<e;)t.push(i);return t})}}).pseudos.nth=j.pseudos.eq,{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})j.pseudos[v]=i(v);for(v in{submit:!0,reset:!0})j.pseudos[v]=r(v);return c.prototype=j.filters=j.pseudos,j.setFilters=new c,C=w.tokenize=function(t,e){var n,i,o,r,s,a,l,u=G[t+" "];if(u)return e?0:u.slice(0);for(s=t,a=[],l=j.preFilter;s;){
// Filters
for(r in
// Comma and first run
n&&!(i=lt.exec(s))||(i&&(
...
type:i[0].replace(at," ")}),s=s.slice(n.length)),j.filter)!(i=ht[r].exec(s))||l[r]&&!(i=l[r](i))||(n=i.shift(),o.push({value:n,type:r,matches:i}),s=s.slice(n.length));if(!n)break}
// Return the length of the invalid excess
// if we're just parsing
// Otherwise, throw an error or return tokens
return e?s.length:s?w.error(t):
// Cache the tokens
G(t,a).slice(0)},O=w.compile=function(t,e/* Internal Use Only */){var n,i=[],o=[],r=U[t+" "];if(!r){for(
...
r=c[0]=c[0].slice(0)).length&&"ID"===(s=r[0]).type&&9===e.nodeType&&D&&j.relative[r[1].type]){if(!(e=(j.find.ID(s.matches[0].replace(bt,wt),e)||[])[0]))return n;
// Precompiled matchers will still verify ancestry, so step up a level
u&&(e=e.parentNode),t=t.slice(r.shift().value.length)}
// Fetch a seed set for right-to-left matching
for(o=ht.needsContext.test(t)?0:r.length;o--&&(s=r[o],!j.relative[a=s.type]);)if((l=j.find[a])&&(i=l(s.matches[0].replace(bt,wt),yt.test(r[0].type)&&h(e.parentNode)||e))){if(
...
// Sort stability
_.sortStable=I.split("").sort(K).join("")===I,
...
_.attributes&&o(function(t){return t.innerHTML="<input/>",t.firstChild.setAttribute("value",""),""===t.firstChild.getAttribute("value")})||e("value",function(t,e,n){if(!n&&"input"===t.nodeName.toLowerCase())return t.defaultValue}),
// Support: IE<9
// Use getAttributeNode to fetch booleans when getAttribute lies
o(function(t){return null==t.getAttribute("disabled")})||e(et,function(t,e,n){var i;if(!n)return!0===t[e]?e.toLowerCase():(i=t.getAttributeNode(e))&&i.specified?i.value:null}),w}(j);_t.find=xt,_t.expr=xt.selectors,
// Deprecated
_t.expr[":"]=_t.expr.pseudos,_t.uniqueSort=_t.unique=xt.uniqueSort,_t.text=xt.getText,_t.isXMLDoc=xt.isXML,_t.contains=xt.contains,_t.escapeSelector=xt.escape;var $t=function(t,e,n){for(var i=[],o=void 0!==n;(t=t[e])&&9!==t.nodeType;)if(1===t.nodeType){if(o&&_t(t).is(n))break;i.push(t)}return i},Ct=function(t,e){for(var n=[];t;t=t.nextSibling)1===t.nodeType&&t!==e&&n.push(t);return n},Ot=_t.expr.match.needsContext,Tt=/^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;_t.filter=function(t,e,n){var i=e[0];return n&&(t=":not("+t+")"),1===e.length&&1===i.nodeType?_t.find.matchesSelector(i,t)?[i]:[]:_t.find.matches(t,_t.grep(e,function(t){return 1===t.nodeType}))},_t.fn.extend({find:function(t){var e,n,i=this.length,o=this;if("string"!=typeof t)return this.pushStack(_t(t).filter(function(){for(e=0;e<i;e++)if(_t.contains(o[e],this))return!0}));for(n=this.pushStack([]),e=0;e<i;e++)_t.find(t,o[e],n);return 1<i?_t.uniqueSort(n):n},filter:function(t){return this.pushStack(e(this,t||[],!1))},not:function(t){return this.pushStack(e(this,t||[],!0))},is:function(t){return!!e(this,
// If this is a positional/relative selector, check membership in the returned set
// so $("p:first").is("p:last") won't return true for a doc with two "p".
"string"==typeof t&&Ot.test(t)?_t(t):t||[],!1).length}});
...
(_t.fn.init=function(t,e,n){var i,o;
...
_t.merge(this,_t.parseHTML(i[1],e&&e.nodeType?e.ownerDocument||e:st,!0)),Tt.test(i[1])&&_t.isPlainObject(e))for(i in e)
...
this[0]=o,this.length=1),this}).prototype=_t.fn,
// Initialize central reference
St=_t(st);var At=/^(?:parents|prev(?:Until|All))/,
// Methods guaranteed to produce a unique set when starting from a unique set
Pt={children:!0,contents:!0,next:!0,prev:!0};_t.fn.extend({has:function(t){var e=_t(t,this),n=e.length;return this.filter(function(){for(var t=0;t<n;t++)if(_t.contains(this,e[t]))return!0})},closest:function(t,e){var n,i=0,o=this.length,r=[],s="string"!=typeof t&&_t(t);
// Positional selectors never match, since there's no _selection_ context
if(!Ot.test(t))for(;i<o;i++)for(n=this[i];n&&n!==e;n=n.parentNode)
// Always skip document fragments
if(n.nodeType<11&&(s?-1<s.index(n):
// Don't pass non-elements to Sizzle
1===n.nodeType&&_t.find.matchesSelector(n,t))){r.push(n);break}return this.pushStack(1<r.length?_t.uniqueSort(r):r)},
// Determine the position of an element within the set
index:function(t){
// No argument, return index in parent
return t?
// Index in selector
"string"==typeof t?dt.call(_t(t),this[0]):dt.call(this,
// If it receives a jQuery object, the first element is used
t.jquery?t[0]:t):this[0]&&this[0].parentNode?this.first().prevAll().length:-1},add:function(t,e){return this.pushStack(_t.uniqueSort(_t.merge(this.get(),_t(t,e))))},addBack:function(t){return this.add(null==t?this.prevObject:this.prevObject.filter(t))}}),_t.each({parent:function(t){var e=t.parentNode;return e&&11!==e.nodeType?e:null},parents:function(t){return $t(t,"parentNode")},parentsUntil:function(t,e,n){return $t(t,"parentNode",n)},next:function(t){return n(t,"nextSibling")},prev:function(t){return n(t,"previousSibling")},nextAll:function(t){return $t(t,"nextSibling")},prevAll:function(t){return $t(t,"previousSibling")},nextUntil:function(t,e,n){return $t(t,"nextSibling",n)},prevUntil:function(t,e,n){return $t(t,"previousSibling",n)},siblings:function(t){return Ct((t.parentNode||{}).firstChild,t)},children:function(t){return Ct(t.firstChild)},contents:function(t){return u(t,"iframe")?t.contentDocument:(
// Support: IE 9 - 11 only, iOS 7 only, Android Browser <=4.3 only
// Treat the template element as a regular one in browsers that
// don't support it.
u(t,"template")&&(t=t.content||t),_t.merge([],t.childNodes))}},function(i,o){_t.fn[i]=function(t,e){var n=_t.map(this,o,t);return"Until"!==i.slice(-5)&&(e=t),e&&"string"==typeof e&&(n=_t.filter(e,n)),1<this.length&&(
// Remove duplicates
Pt[i]||_t.uniqueSort(n),
// Reverse order for parents* and prev-derivatives
At.test(i)&&n.reverse()),this.pushStack(n)}});var Lt=/[^\x20\t\r\n\f]+/g;_t.Callbacks=function(i){
// Convert options from String-formatted to Object-formatted if needed
// (we check in cache first)
i="string"==typeof i?c(i):_t.extend({},i);var// Flag to know if list is currently firing
n,
...
t&&!n&&(a=r.length-1,s.push(t)),function n(t){_t.each(t,function(t,e){yt(e)?i.unique&&u.has(e)||r.push(e):e&&e.length&&"string"!==g(e)&&
// Inspect recursively
n(e)})}(arguments),t&&!n&&l()),this},
// Remove a callback from the list
remove:function(){return _t.each(arguments,function(t,e){for(var n;-1<(n=_t.inArray(e,r,n));)r.splice(n,1),
// Handle firing indexes
n<=a&&a--}),this},
// Check if a given callback is in the list.
// If no argument is given, return whether or not list has callbacks attached.
has:function(t){return t?-1<_t.inArray(t,r):0<r.length},
...
fired:function(){return!!e}};return u},_t.extend({Deferred:function(t){var r=[
...
pipe:function(){var o=arguments;return _t.Deferred(function(i){_t.each(r,function(t,e){
...
e=a?t:function(){try{t()}catch(t){_t.Deferred.exceptionHook&&_t.Deferred.exceptionHook(t,e.stackTrace),
...
_t.Deferred.getStackHook&&(e.stackTrace=_t.Deferred.getStackHook()),j.setTimeout(e))}}var u=0;return _t.Deferred(function(t){
...
promise:function(t){return null!=t?_t.extend(t,s):s}},a={};
// Add list-specific methods
// All done!
return _t.each(r,function(t,e){var n=e[2],i=e[5];
...
var Dt=/^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;_t.Deferred.exceptionHook=function(t,e){
// Support: IE 8 - 9 only
// Console exists when dev tools are open, which can happen at any time
j.console&&j.console.warn&&t&&Dt.test(t.name)&&j.console.warn("jQuery.Deferred exception: "+t.message,t.stack,e)},_t.readyException=function(t){j.setTimeout(function(){throw t})};
// The deferred used on DOM ready
var Mt=_t.Deferred();_t.fn.ready=function(t){return Mt.then(t).catch(function(t){_t.readyException(t)}),this},_t.extend({
...
_t.isReady=!0)!==t&&0<--_t.readyWait||
// If there are functions bound, to execute
Mt.resolveWith(st,[_t])}}),_t.ready.then=Mt.then,"complete"===st.readyState||"loading"!==st.readyState&&!st.documentElement.doScroll?
// Handle it asynchronously to allow scripts the opportunity to delay ready
j.setTimeout(_t.ready):(
...
var qt=function(t,e,n,i,o,r,s){var a=0,l=t.length,u=null==n;
// Sets many values
if("object"===g(n))for(a in o=!0,n)qt(t,e,a,n[a],!0,r,s);
// Sets one value
else if(void 0!==i&&(o=!0,yt(i)||(s=!0),u&&(
// Bulk operations run against the entire set
e=s?(e.call(t,i),null):(u=e,function(t,e,n){return u.call(_t(t),n)})),e))for(;a<l;a++)e(t[a],n,s?i:i.call(t[a],a,e(t[a],n)));return o?t:
// Gets
u?e.call(t):l?e(t[0],n):r},Ht=/^-ms-/,Rt=/-([a-z])/g,It=function(t){
// Accepts only:
//  - Node
//    - Node.ELEMENT_NODE
//    - Node.DOCUMENT_NODE
...
t.nodeType?t[this.expando]=void 0:delete t[this.expando])}},hasData:function(t){var e=t[this.expando];return void 0!==e&&!_t.isEmptyObject(e)}};var Nt=new r,Ft=new r,Bt=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Wt=/[A-Z]/g;_t.extend({hasData:function(t){return Ft.hasData(t)||Nt.hasData(t)},data:function(t,e,n){return Ft.access(t,e,n)},removeData:function(t,e){Ft.remove(t,e)},
// TODO: Now that all calls to _data and _removeData have been replaced
// with direct calls to dataPriv methods, these can be deprecated.
_data:function(t,e,n){return Nt.access(t,e,n)},_removeData:function(t,e){Nt.remove(t,e)}}),_t.fn.extend({data:function(n,t){var e,i,o,r=this[0],s=r&&r.attributes;
// Gets all values
if(void 0!==n)
// Sets multiple values
return"object"==typeof n?this.each(function(){Ft.set(this,n)}):qt(this,function(t){var e;
...
s[e]&&0===(i=s[e].name).indexOf("data-")&&(i=h(i.slice(5)),p(r,i,o[i]));Nt.set(r,"hasDataAttrs",!0)}return o},removeData:function(t){return this.each(function(){Ft.remove(this,t)})}}),_t.extend({queue:function(t,e,n){var i;if(t)return e=(e||"fx")+"queue",i=Nt.get(t,e),
// Speed up dequeue by getting out quickly if this is just a lookup
n&&(!i||Array.isArray(n)?i=Nt.access(t,e,_t.makeArray(n)):i.push(n)),i||[]},dequeue:function(t,e){e=e||"fx";var n=_t.queue(t,e),i=n.length,o=n.shift(),r=_t._queueHooks(t,e),s=function(){_t.dequeue(t,e)};
...
_queueHooks:function(t,e){var n=e+"queueHooks";return Nt.get(t,n)||Nt.access(t,n,{empty:_t.Callbacks("once memory").add(function(){Nt.remove(t,[e+"queue",n])})})}}),_t.fn.extend({queue:function(e,n){var t=2;return"string"!=typeof e&&(n=e,e="fx",t--),arguments.length<t?_t.queue(this[0],e):void 0===n?this:this.each(function(){var t=_t.queue(this,e,n);
// Ensure a hooks for this queue
_t._queueHooks(this,e),"fx"===e&&"inprogress"!==t[0]&&_t.dequeue(this,e)})},dequeue:function(t){return this.each(function(){_t.dequeue(this,t)})},clearQueue:function(t){return this.queue(t||"fx",[])},
// Get a promise resolved when queues of a certain type
// are emptied (fx is the type by default)
promise:function(t,e){var n,i=1,o=_t.Deferred(),r=this,s=this.length,a=function(){--i||o.resolveWith(r,[r])};for("string"!=typeof t&&(e=t,t=void 0),t=t||"fx";s--;)(n=Nt.get(r[s],t+"queueHooks"))&&n.empty&&(i++,n.empty.add(a));return a(),o.promise(e)}});var Gt=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Ut=new RegExp("^(?:([+-])=|)("+Gt+")([a-z%]*)$","i"),Kt=["Top","Right","Bottom","Left"],Qt=function(t,e){
...
// in the document.
_t.contains(t.ownerDocument,t)&&"none"===_t.css(t,"display")},Yt=function(t,e,n,i){var o,r,s={};
// Remember the old values, and insert the new ones
for(r in e)s[r]=t.style[r],t.style[r]=e[r];
// Revert the old values
for(r in o=n.apply(t,i||[]),e)t.style[r]=s[r];return o},Vt={};_t.fn.extend({show:function(){return b(this,!0)},hide:function(){return b(this)},toggle:function(t){return"boolean"==typeof t?t?this.show():this.hide():this.each(function(){Qt(this)?_t(this).show():_t(this).hide()})}});var Xt=/^(?:checkbox|radio)$/i,Zt=/<([a-z][^\/\0>\x20\t\r\n\f]+)/i,Jt=/^$|^module$|\/(?:java|ecma)script/i,te={
// Support: IE <=9 only
...
ie.innerHTML="<textarea>x</textarea>",vt.noCloneChecked=!!ie.cloneNode(!0).lastChild.defaultValue;var re=st.documentElement,se=/^key/,ae=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,le=/^([^.]*)(?:\.(.+)|)/;_t.event={global:{},add:function(e,t,n,i,o){var r,s,a,l,u,c,d,f,h,p,m,g=Nt.get(e);
...
o&&_t.find.matchesSelector(re,o),
...
return void 0!==_t&&_t.event.triggered!==t.type?_t.event.dispatch.apply(e,arguments):void 0}),u=(
// Handle multiple events separated by a space
t=(t||"").match(Lt)||[""]).length;u--;)h=m=(a=le.exec(t[u])||[])[1],p=(a[2]||"").split(".").sort(),
// There *must* be a type, no attaching namespace-only handlers
h&&(
// If event changes its type, use the special event handlers for the changed type
d=_t.event.special[h]||{},
// If selector defined, determine special event api type, otherwise given type
h=(o?d.delegateType:d.bindType)||h,
// Update special based on newly reset type
d=_t.event.special[h]||{},
// handleObj is passed to all event handlers
c=_t.extend({type:h,origType:m,data:i,handler:n,guid:n.guid,selector:o,needsContext:o&&_t.expr.match.needsContext.test(o),namespace:p.join(".")},r),
...
remove:function(t,e,n,i,o){var r,s,a,l,u,c,d,f,h,p,m,g=Nt.hasData(t)&&Nt.get(t);if(g&&(l=g.events)){for(u=(
// Once for each type.namespace in types; type may be omitted
e=(e||"").match(Lt)||[""]).length;u--;)
// Unbind all events (on this namespace, if provided) for the element
if(h=m=(a=le.exec(e[u])||[])[1],p=(a[2]||"").split(".").sort(),h){for(d=_t.event.special[h]||{},f=l[h=(i?d.delegateType:d.bindType)||h]||[],a=a[2]&&new RegExp("(^|\\.)"+p.join("\\.(?:.*\\.|)")+"(\\.|$)"),
...
s&&!f.length&&(d.teardown&&!1!==d.teardown.call(t,p,g.handle)||_t.removeEvent(t,h,g.handle),delete l[h])}else for(h in l)_t.event.remove(t,h+e[u],n,i,!0);
// Remove data and the expando if it's no longer used
_t.isEmptyObject(l)&&Nt.remove(t,"handle events")}},dispatch:function(t){
// Make a writable jQuery.Event from the native event object
var e=_t.event.fix(t),n,i,o,r,s,a,l=new Array(arguments.length),u=(Nt.get(this,"events")||{})[e.type]||[],c=_t.event.special[e.type]||{};for(
...
// Determine handlers
a=_t.event.handlers.call(this,e,u),
...
e.rnamespace&&!e.rnamespace.test(s.namespace)||(e.handleObj=s,e.data=s.data,void 0!==(o=((_t.event.special[s.origType]||{}).handle||s.handler).apply(r.elem,l))&&!1===(e.result=o)&&(e.preventDefault(),e.stopPropagation()));
...
void 0!==t.result&&t.originalEvent&&(t.originalEvent.returnValue=t.result)}}}},_t.removeEvent=function(t,e,n){
// This "if" is needed for plain objects
t.removeEventListener&&t.removeEventListener(e,n)},_t.Event=function(t,e){
...
_t.each({mouseenter:"mouseover",mouseleave:"mouseout",pointerenter:"pointerover",pointerleave:"pointerout"},function(t,r){_t.event.special[t]={delegateType:r,bindType:r,handle:function(t){var e,n=this,i=t.relatedTarget,o=t.handleObj;
// For mouseenter/leave call the handler if related is outside the target.
// NB: No relatedTarget if the mouse left/entered the browser window
return i&&(i===n||_t.contains(n,i))||(t.type=o.origType,e=o.handler.apply(this,arguments),t.type=r),e}}}),_t.fn.extend({on:function(t,e,n,i){return O(this,t,e,n,i)},one:function(t,e,n,i){return O(this,t,e,n,i,1)},off:function(t,e,n){var i,o;if(t&&t.preventDefault&&t.handleObj)
// ( event )  dispatched jQuery.Event
return i=t.handleObj,_t(t.delegateTarget).off(i.namespace?i.origType+"."+i.namespace:i.origType,i.selector,i.handler),this;if("object"!=typeof t)return!1!==e&&"function"!=typeof e||(
// ( types [, fn] )
n=e,e=void 0),!1===n&&(n=$),this.each(function(){_t.event.remove(this,t,n,e)});
...
de=/checked\s*(?:[^=]|=\s*.checked.)/i,fe=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;_t.extend({htmlPrefilter:function(t){return t.replace(ue,"<$1></$2>")},clone:function(t,e,n){var i,o,r,s,a=t.cloneNode(!0),l=_t.contains(t.ownerDocument,t);
// Fix IE cloning issues
if(!(vt.noCloneChecked||1!==t.nodeType&&11!==t.nodeType||_t.isXMLDoc(t)))for(
...
return 0<(s=w(a,"script")).length&&k(s,!l&&w(t,"script")),a},cleanData:function(t){for(var e,n,i,o=_t.event.special,r=0;void 0!==(n=t[r]);r++)if(It(n)){if(e=n[Nt.expando]){if(e.events)for(i in e.events)o[i]?_t.event.remove(n,i):_t.removeEvent(n,i,e.handle);
// Support: Chrome <=35 - 45+
// Assign undefined instead of using delete, see Data#remove
n[Nt.expando]=void 0}n[Ft.expando]&&(
// Support: Chrome <=35 - 45+
// Assign undefined instead of using delete, see Data#remove
n[Ft.expando]=void 0)}}}),_t.fn.extend({detach:function(t){return L(this,t,!0)},remove:function(t){return L(this,t)},text:function(t){return qt(this,function(t){return void 0===t?_t.text(this):this.empty().each(function(){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||(this.textContent=t)})},null,t,arguments.length)},append:function(){return P(this,arguments,function(t){var e;1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||T(this,t).appendChild(t)})},prepend:function(){return P(this,arguments,function(t){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var e=T(this,t);e.insertBefore(t,e.firstChild)}})},before:function(){return P(this,arguments,function(t){this.parentNode&&this.parentNode.insertBefore(t,this)})},after:function(){return P(this,arguments,function(t){this.parentNode&&this.parentNode.insertBefore(t,this.nextSibling)})},empty:function(){for(var t,e=0;null!=(t=this[e]);e++)1===t.nodeType&&(
// Prevent memory leaks
_t.cleanData(w(t,!1)),
// Remove any remaining nodes
t.textContent="");return this},clone:function(t,e){return t=null!=t&&t,e=null==e?t:e,this.map(function(){return _t.clone(this,t,e)})},html:function(t){return qt(this,function(t){var e=this[0]||{},n=0,i=this.length;if(void 0===t&&1===e.nodeType)return e.innerHTML;
// See if we can take a shortcut and just use innerHTML
if("string"==typeof t&&!ce.test(t)&&!te[(Zt.exec(t)||["",""])[1].toLowerCase()]){t=_t.htmlPrefilter(t);try{for(;n<i;n++)
// Remove element nodes and prevent memory leaks
1===(e=this[n]||{}).nodeType&&(_t.cleanData(w(e,!1)),e.innerHTML=t);e=0}catch(t){}}e&&this.empty().append(t)},null,t,arguments.length)},replaceWith:function(){var n=[];
// Make the changes, replacing each non-ignored context element with the new content
return P(this,arguments,function(t){var e=this.parentNode;_t.inArray(this,n)<0&&(_t.cleanData(w(this)),e&&e.replaceChild(t,this));
// Force callback invocation
},n)}}),_t.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(t,s){_t.fn[t]=function(t){for(var e,n=[],i=_t(t),o=i.length-1,r=0;r<=o;r++)e=r===o?this:this.clone(!0),_t(i[r])[s](e),
// Support: Android <=4.0 only, PhantomJS 1 only
...
var e=t.ownerDocument.defaultView;return e&&e.opener||(e=j),e.getComputedStyle(t)},me=new RegExp(Kt.join("|"),"i");!function(){
// Executing both pixelPosition & boxSizingReliable tests require only one layout
// so they're executed at the same time to save the second computation.
function t(){
// This is a singleton, we need to execute it only once
if(l){a.style.cssText="position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",l.style.cssText="position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%",re.appendChild(a).appendChild(l);var t=j.getComputedStyle(l);n="1%"!==t.top,
...
l.style.backgroundClip="content-box",l.cloneNode(!0).style.backgroundClip="",vt.clearCloneStyle="content-box"===l.style.backgroundClip,_t.extend(vt,{boxSizingReliable:function(){return t(),i},pixelBoxStyles:function(){return t(),r},pixelPosition:function(){return t(),n},reliableMarginLeft:function(){return t(),s},scrollboxSize:function(){return t(),o}}))}();var
// Swappable if display is none or starts with table
// except "table", "table-cell", or "table-caption"
// See here for display values: https://developer.mozilla.org/en-US/docs/CSS/display
ge=/^(none|table(?!-c[ea]).+)/,ve=/^--/,ye={position:"absolute",visibility:"hidden",display:"block"},be={letterSpacing:"0",fontWeight:"400"},we=["Webkit","Moz","ms"],ke=st.createElement("div").style;_t.extend({
...
s=_t.cssHooks[e]||_t.cssHooks[a],void 0===n)
...
"number"===r&&(n+=o&&o[3]||(_t.cssNumber[a]?"":"px")),
...
s=_t.cssHooks[e]||_t.cssHooks[a])&&"get"in s&&(o=s.get(t,!0,n)),
// Otherwise, if a way to get the computed value exists, use that
void 0===o&&(o=D(t,e,i)),
// Convert "normal" to computed value
"normal"===o&&e in be&&(o=be[e]),""===n||n?(r=parseFloat(o),!0===n||isFinite(r)?r||0:o):o}}),_t.each(["height","width"],function(t,a){_t.cssHooks[a]={get:function(t,e,n){if(e)
...
t.getClientRects().length&&t.getBoundingClientRect().width?N(t,a,n):Yt(t,ye,function(){return N(t,a,n)})},set:function(t,e,n){var i,o=pe(t),r="border-box"===_t.css(t,"boxSizing",!1,o),s=n&&I(t,a,n,r,o);
...
s&&(i=Ut.exec(e))&&"px"!==(i[3]||"px")&&(t.style[a]=e,e=_t.css(t,a)),R(t,e,s)}}}),_t.cssHooks.marginLeft=M(vt.reliableMarginLeft,function(t,e){if(e)return(parseFloat(D(t,"marginLeft"))||t.getBoundingClientRect().left-Yt(t,{marginLeft:0},function(){return t.getBoundingClientRect().left}))+"px"}),
// These hooks are used by animate to expand properties
_t.each({margin:"",padding:"",border:"Width"},function(o,r){_t.cssHooks[o+r]={expand:function(t){for(var e=0,n={},
// Assumes a single number if not a string
i="string"==typeof t?t.split(" "):[t];e<4;e++)n[o+Kt[e]+r]=i[e]||i[e-2]||i[0];return n}},"margin"!==o&&(_t.cssHooks[o+r].set=R)}),_t.fn.extend({css:function(t,e){return qt(this,function(t,e,n){var i,o,r={},s=0;if(Array.isArray(e)){for(i=pe(t),o=e.length;s<o;s++)r[e[s]]=_t.css(t,e[s],!1,i);return r}return void 0!==n?_t.style(t,e,n):_t.css(t,e)},t,e,1<arguments.length)}}),(_t.Tween=F).prototype={constructor:F,init:function(t,e,n,i,o,r){this.elem=t,this.prop=n,this.easing=o||_t.easing._default,this.options=e,this.start=this.now=this.cur(),this.end=i,this.unit=r||(_t.cssNumber[n]?"":"px")},cur:function(){var t=F.propHooks[this.prop];return t&&t.get?t.get(this):F.propHooks._default.get(this)},run:function(t){var e,n=F.propHooks[this.prop];return this.options.duration?this.pos=e=_t.easing[this.easing](t,this.options.duration*t,0,1,this.options.duration):this.pos=e=t,this.now=(this.end-this.start)*e+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),n&&n.set?n.set(this):F.propHooks._default.set(this),this}},F.prototype.init.prototype=F.prototype,F.propHooks={_default:{get:function(t){var e;
...
e=_t.css(t.elem,t.prop,""))&&"auto"!==e?e:0},set:function(t){
...
F.propHooks.scrollTop=F.propHooks.scrollLeft={set:function(t){t.elem.nodeType&&t.elem.parentNode&&(t.elem[t.prop]=t.now)}},_t.easing={linear:function(t){return t},swing:function(t){return.5-Math.cos(t*Math.PI)/2},_default:"swing"},_t.fx=F.prototype.init,
// Back compat <1.8 extension point
_t.fx.step={};var _e,je,xe=/^(?:toggle|show|hide)$/,$e=/queueHooks$/,Ce,Oe,Te;_t.Animation=_t.extend(Y,{tweeners:{"*":[function(t,e){var n=this.createTween(t,e);return v(n.elem,t,Ut.exec(e),n),n}]},tweener:function(t,e){for(var n,i=0,o=(t=yt(t)?(e=t,["*"]):t.match(Lt)).length;i<o;i++)n=t[i],Y.tweeners[n]=Y.tweeners[n]||[],Y.tweeners[n].unshift(e)},prefilters:[K],prefilter:function(t,e){e?Y.prefilters.unshift(t):Y.prefilters.push(t)}}),_t.speed=function(t,e,n){var i=t&&"object"==typeof t?_t.extend({},t):{complete:n||!n&&e||yt(t)&&t,duration:t,easing:n&&e||e&&!yt(e)&&e};
// Go to the end state if fx are off
return _t.fx.off?i.duration=0:"number"!=typeof i.duration&&(i.duration in _t.fx.speeds?i.duration=_t.fx.speeds[i.duration]:i.duration=_t.fx.speeds._default),
// Normalize opt.queue - true/undefined/null -> "fx"
null!=i.queue&&!0!==i.queue||(i.queue="fx"),
// Queueing
i.old=i.complete,i.complete=function(){yt(i.old)&&i.old.call(this),i.queue&&_t.dequeue(this,i.queue)},i},_t.fn.extend({fadeTo:function(t,e,n,i){
// Show any hidden elements after setting opacity to 0
return this.filter(Qt).css("opacity",0).show().end().animate({opacity:e},t,n,i)},animate:function(e,t,n,i){var o=_t.isEmptyObject(e),r=_t.speed(t,n,i),s=function(){
// Operate on a copy of prop so per-property easing won't be lost
var t=Y(this,_t.extend({},e),r);
// Empty animations, or finishing resolves immediately
(o||Nt.get(this,"finish"))&&t.stop(!0)};return s.finish=s,o||!1===r.queue?this.each(s):this.queue(r.queue,s)},stop:function(o,t,r){var s=function(t){var e=t.stop;delete t.stop,e(r)};return"string"!=typeof o&&(r=t,t=o,o=void 0),t&&!1!==o&&this.queue(o||"fx",[]),this.each(function(){var t=!0,e=null!=o&&o+"queueHooks",n=_t.timers,i=Nt.get(this);if(e)i[e]&&i[e].stop&&s(i[e]);else for(e in i)i[e]&&i[e].stop&&$e.test(e)&&s(i[e]);for(e=n.length;e--;)n[e].elem!==this||null!=o&&n[e].queue!==o||(n[e].anim.stop(r),t=!1,n.splice(e,1));
// Start the next in the queue if the last step wasn't forced.
// Timers currently will call their complete callbacks, which
// will dequeue but only if they were gotoEnd.
!t&&r||_t.dequeue(this,o)})},finish:function(s){return!1!==s&&(s=s||"fx"),this.each(function(){var t,e=Nt.get(this),n=e[s+"queue"],i=e[s+"queueHooks"],o=_t.timers,r=n?n.length:0;
// Enable finishing flag on private data
// Look for any active animations, and finish them
for(e.finish=!0,
// Empty the queue first
_t.queue(this,s,[]),i&&i.stop&&i.stop.call(this,!0),t=o.length;t--;)o[t].elem===this&&o[t].queue===s&&(o[t].anim.stop(!0),o.splice(t,1));
// Look for any animations in the old queue and finish them
for(t=0;t<r;t++)n[t]&&n[t].finish&&n[t].finish.call(this);
// Turn off finishing flag
delete e.finish})}}),_t.each(["toggle","show","hide"],function(t,i){var o=_t.fn[i];_t.fn[i]=function(t,e,n){return null==t||"boolean"==typeof t?o.apply(this,arguments):this.animate(G(i,!0),t,e,n)}}),
// Generate shortcuts for custom animations
_t.each({slideDown:G("show"),slideUp:G("hide"),slideToggle:G("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(t,i){_t.fn[t]=function(t,e,n){return this.animate(i,t,e,n)}}),_t.timers=[],_t.fx.tick=function(){var t,e=0,n=_t.timers;for(_e=Date.now();e<n.length;e++)
// Run the timer and safely remove it when done (allowing for external removal)
(t=n[e])()||n[e]!==t||n.splice(e--,1);n.length||_t.fx.stop(),_e=void 0},_t.fx.timer=function(t){_t.timers.push(t),_t.fx.start()},_t.fx.interval=13,_t.fx.start=function(){je||(je=!0,B())},_t.fx.stop=function(){je=null},_t.fx.speeds={slow:600,fast:200,
// Default speed
_default:400},
// Based off of the plugin by Clint Helfers, with permission.
// https://web.archive.org/web/20100324014747/http://blindsignals.com/index.php/2009/07/jquery-delay/
_t.fn.delay=function(i,t){return i=_t.fx&&_t.fx.speeds[i]||i,t=t||"fx",this.queue(t,function(t,e){var n=j.setTimeout(t,i);e.stop=function(){j.clearTimeout(n)}})},Ce=st.createElement("input"),Te=st.createElement("select").appendChild(st.createElement("option")),Ce.type="checkbox",
...
Ce=st.createElement("input")).value="t",Ce.type="radio",vt.radioValue="t"===Ce.value;var Se,Ee=_t.expr.attrHandle;_t.fn.extend({attr:function(t,e){return qt(this,_t.attr,t,e,1<arguments.length)},removeAttr:function(t){return this.each(function(){_t.removeAttr(this,t)})}}),_t.extend({attr:function(t,e,n){var i,o,r=t.nodeType;
// Don't get/set attributes on text, comment and attribute nodes
if(3!==r&&8!==r&&2!==r)
// Fallback to prop when attributes are not supported
return void 0===t.getAttribute?_t.prop(t,e,n):(
// Attribute hooks are determined by the lowercase version
// Grab necessary hook if one is defined
1===r&&_t.isXMLDoc(t)||(o=_t.attrHooks[e.toLowerCase()]||(_t.expr.match.bool.test(e)?Se:void 0)),void 0!==n?null===n?void _t.removeAttr(t,e):o&&"set"in o&&void 0!==(i=o.set(t,n,e))?i:(t.setAttribute(e,n+""),n):o&&"get"in o&&null!==(i=o.get(t,e))?i:null==(i=_t.find.attr(t,e))?void 0:i)},attrHooks:{type:{set:function(t,e){if(!vt.radioValue&&"radio"===e&&u(t,"input")){var n=t.value;return t.setAttribute("type",e),n&&(t.value=n),e}}}},removeAttr:function(t,e){var n,i=0,
...
_t.removeAttr(t,n):t.setAttribute(n,n),n}},_t.each(_t.expr.match.bool.source.match(/\w+/g),function(t,e){var s=Ee[e]||_t.find.attr;Ee[e]=function(t,e,n){var i,o,r=e.toLowerCase();return n||(
// Avoid an infinite loop by temporarily removing this function from the getter
o=Ee[r],Ee[r]=i,i=null!=s(t,e,n)?r:null,Ee[r]=o),i}});var ze=/^(?:input|select|textarea|button)$/i,Ae=/^(?:a|area)$/i;_t.fn.extend({prop:function(t,e){return qt(this,_t.prop,t,e,1<arguments.length)},removeProp:function(t){return this.each(function(){delete this[_t.propFix[t]||t]})}}),_t.extend({prop:function(t,e,n){var i,o,r=t.nodeType;
// Don't get/set properties on text, comment and attribute nodes
if(3!==r&&8!==r&&2!==r)return 1===r&&_t.isXMLDoc(t)||(
// Fix name and attach hooks
e=_t.propFix[e]||e,o=_t.propHooks[e]),void 0!==n?o&&"set"in o&&void 0!==(i=o.set(t,n,e))?i:t[e]=n:o&&"get"in o&&null!==(i=o.get(t,e))?i:t[e]},propHooks:{tabIndex:{get:function(t){
// Support: IE <=9 - 11 only
// elem.tabIndex doesn't always return the
// correct value when it hasn't been explicitly set
// https://web.archive.org/web/20141116233347/http://fluidproject.org/blog/2008/01/09/getting-setting-and-removing-tabindex-values-with-javascript/
// Use proper attribute retrieval(#12072)
var e=_t.find.attr(t,"tabindex");return e?parseInt(e,10):ze.test(t.nodeName)||Ae.test(t.nodeName)&&t.href?0:-1}}},propFix:{for:"htmlFor",class:"className"}}),
// Support: IE <=11 only
...
vt.optSelected||(_t.propHooks.selected={get:function(t){
/* eslint no-unused-expressions: "off" */
var e=t.parentNode;return e&&e.parentNode&&e.parentNode.selectedIndex,null},set:function(t){
/* eslint no-unused-expressions: "off" */
var e=t.parentNode;e&&(e.selectedIndex,e.parentNode&&e.parentNode.selectedIndex)}}),_t.each(["tabIndex","readOnly","maxLength","cellSpacing","cellPadding","rowSpan","colSpan","useMap","frameBorder","contentEditable"],function(){_t.propFix[this.toLowerCase()]=this}),_t.fn.extend({addClass:function(e){var t,n,i,o,r,s,a,l=0;if(yt(e))return this.each(function(t){_t(this).addClass(e.call(this,t,X(this)))});if((t=Z(e)).length)for(;n=this[l++];)if(o=X(n),i=1===n.nodeType&&" "+V(o)+" "){for(s=0;r=t[s++];)i.indexOf(" "+r+" ")<0&&(i+=r+" ");
// Only assign if different to avoid unneeded rendering.
o!==(a=V(i))&&n.setAttribute("class",a)}return this},removeClass:function(e){var t,n,i,o,r,s,a,l=0;if(yt(e))return this.each(function(t){_t(this).removeClass(e.call(this,t,X(this)))});if(!arguments.length)return this.attr("class","");if((t=Z(e)).length)for(;n=this[l++];)if(o=X(n),
// This expression is here for better compressibility (see addClass)
i=1===n.nodeType&&" "+V(o)+" "){for(s=0;r=t[s++];)
// Remove *all* instances
for(;-1<i.indexOf(" "+r+" ");)i=i.replace(" "+r+" "," ");
// Only assign if different to avoid unneeded rendering.
o!==(a=V(i))&&n.setAttribute("class",a)}return this},toggleClass:function(o,e){var r=typeof o,s="string"===r||Array.isArray(o);return"boolean"==typeof e&&s?e?this.addClass(o):this.removeClass(o):yt(o)?this.each(function(t){_t(this).toggleClass(o.call(this,t,X(this),e),e)}):this.each(function(){var t,e,n,i;if(s)for(
// Toggle individual class names
e=0,n=_t(this),i=Z(o);t=i[e++];)
...
this.setAttribute&&this.setAttribute("class",t||!1===o?"":Nt.get(this,"__className__")||""))})},hasClass:function(t){var e,n,i=0;for(e=" "+t+" ";n=this[i++];)if(1===n.nodeType&&-1<(" "+V(X(n))+" ").indexOf(e))return!0;return!1}});var Pe=/\r/g;_t.fn.extend({val:function(n){var i,t,o,e=this[0];return arguments.length?(o=yt(n),this.each(function(t){var e;1===this.nodeType&&(
// Treat null/undefined as ""; convert numbers to string
null==(e=o?n.call(this,t,_t(this).val()):n)?e="":"number"==typeof e?e+="":Array.isArray(e)&&(e=_t.map(e,function(t){return null==t?"":t+""})),
// If set returns undefined, fall back to normal setting
(i=_t.valHooks[this.type]||_t.valHooks[this.nodeName.toLowerCase()])&&"set"in i&&void 0!==i.set(this,e,"value")||(this.value=e))})):e?(i=_t.valHooks[e.type]||_t.valHooks[e.nodeName.toLowerCase()])&&"get"in i&&void 0!==(t=i.get(e,"value"))?t:
// Handle most common string cases
"string"==typeof(t=e.value)?t.replace(Pe,""):null==t?"":t:void 0}}),_t.extend({valHooks:{option:{get:function(t){var e=_t.find.attr(t,"value");return null!=e?e:
// Support: IE <=10 - 11 only
// option.text throws exceptions (#14686, #14858)
// Strip and collapse whitespace
// https://html.spec.whatwg.org/#strip-and-collapse-whitespace
V(_t.text(t))}},select:{get:function(t){var e,n,i,o=t.options,r=t.selectedIndex,s="select-one"===t.type,a=s?null:[],l=s?r+1:o.length;
...
e=_t(n).val(),s)return e;
// Multi-Selects return an array
a.push(e)}return a},set:function(t,e){for(var n,i,o=t.options,r=_t.makeArray(e),s=o.length;s--;)
/* eslint-disable no-cond-assign */
((i=o[s]).selected=-1<_t.inArray(_t.valHooks.option.get(i),r))&&(n=!0)
/* eslint-enable no-cond-assign */;
// Force browsers to behave consistently when non-matching value is set
return n||(t.selectedIndex=-1),r}}}}),
// Radios and checkboxes getter/setter
_t.each(["radio","checkbox"],function(){_t.valHooks[this]={set:function(t,e){if(Array.isArray(e))return t.checked=-1<_t.inArray(_t(t).val(),e)}},vt.checkOn||(_t.valHooks[this].get=function(t){return null===t.getAttribute("value")?"on":t.value})}),
// Return jQuery for attributes-only inclusion
vt.focusin="onfocusin"in j;var Le=/^(?:focusinfocus|focusoutblur)$/,De=function(t){t.stopPropagation()};_t.extend(_t.event,{trigger:function(t,e,n,i){var o,r,s,a,l,u,c,d,f=[n||st],h=pt.call(t,"type")?t.type:t,p=pt.call(t,"namespace")?t.namespace.split("."):[];
// Don't do events on text and comment nodes
if(r=d=s=n=n||st,3!==n.nodeType&&8!==n.nodeType&&!Le.test(h+_t.event.triggered)&&(-1<h.indexOf(".")&&(
// Namespaced trigger; create a regexp to match event type in handle()
h=(p=h.split(".")).shift(),p.sort()),l=h.indexOf(":")<0&&"on"+h,
// Trigger bitmask: & 1 for native handlers; & 2 for jQuery (always true)
(
// Caller can pass in a jQuery.Event object, Object, or just an event type string
t=t[_t.expando]?t:new _t.Event(h,"object"==typeof t&&t)).isTrigger=i?2:3,t.namespace=p.join("."),t.rnamespace=t.namespace?new RegExp("(^|\\.)"+p.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,
// Clean up the event in case it is being reused
t.result=void 0,t.target||(t.target=n),
// Clone any incoming data and prepend the event, creating the handler arg list
e=null==e?[t]:_t.makeArray(e,[t]),
// Allow special events to draw outside the lines
c=_t.event.special[h]||{},i||!c.trigger||!1!==c.trigger.apply(n,e))){
...
s===(n.ownerDocument||st)&&f.push(s.defaultView||s.parentWindow||j)}
...
i||t.isDefaultPrevented()||c._default&&!1!==c._default.apply(f.pop(),e)||!It(n)||
...
_t.event.triggered=h,t.isPropagationStopped()&&d.addEventListener(h,De),n[h](),t.isPropagationStopped()&&d.removeEventListener(h,De),_t.event.triggered=void 0,s&&(n[l]=s)),t.result}
// focus/blur morphs to focusin/out; ensure we're not firing them right now
},
// Piggyback on a donor event to simulate a different one
// Used only for `focus(in | out)` events
simulate:function(t,e,n){var i=_t.extend(new _t.Event,n,{type:t,isSimulated:!0});_t.event.trigger(i,null,e)}}),_t.fn.extend({trigger:function(t,e){return this.each(function(){_t.event.trigger(t,e,this)})},triggerHandler:function(t,e){var n=this[0];if(n)return _t.event.trigger(t,e,n,!0)}}),
// Support: Firefox <=44
...
vt.focusin||_t.each({focus:"focusin",blur:"focusout"},function(n,i){
// Attach a single capturing handler on the document while someone wants focusin/focusout
var o=function(t){_t.event.simulate(i,t.target,_t.event.fix(t))};_t.event.special[i]={setup:function(){var t=this.ownerDocument||this,e=Nt.access(t,i);e||t.addEventListener(n,o,!0),Nt.access(t,i,(e||0)+1)},teardown:function(){var t=this.ownerDocument||this,e=Nt.access(t,i)-1;e?Nt.access(t,i,e):(t.removeEventListener(n,o,!0),Nt.remove(t,i))}}});var Me=j.location,qe=Date.now(),He=/\?/;
// Cross-browser xml parsing
_t.parseXML=function(t){var e;if(!t||"string"!=typeof t)return null;
// Support: IE 9 - 11 only
// IE throws on parseFromString with invalid input.
try{e=(new j.DOMParser).parseFromString(t,"text/xml")}catch(t){e=void 0}return e&&!e.getElementsByTagName("parsererror").length||_t.error("Invalid XML: "+t),e};var Re=/\[\]$/,Ie=/\r?\n/g,Ne=/^(?:submit|button|image|reset|file)$/i,Fe=/^(?:input|select|textarea|keygen)/i;_t.param=function(t,e){var n,i=[],o=function(t,e){
...
_t.each(t,function(){o(this.name,this.value)});else
// If traditional, encode the "old" way (the way 1.3.2 or older
// did it), otherwise encode params recursively.
for(n in t)J(n,t[n],e,o);
// Return the resulting serialization
return i.join("&")},_t.fn.extend({serialize:function(){return _t.param(this.serializeArray())},serializeArray:function(){return this.map(function(){
// Can add propHook for "elements" to filter or add form elements
var t=_t.prop(this,"elements");return t?_t.makeArray(t):this}).filter(function(){var t=this.type;
// Use .is( ":disabled" ) so that fieldset[disabled] works
return this.name&&!_t(this).is(":disabled")&&Fe.test(this.nodeName)&&!Ne.test(t)&&(this.checked||!Xt.test(t))}).map(function(t,e){var n=_t(this).val();return null==n?null:Array.isArray(n)?_t.map(n,function(t){return{name:e.name,value:t.replace(Ie,"\r\n")}}):{name:e.name,value:n.replace(Ie,"\r\n")}}).get()}});var Be=/%20/g,We=/#.*$/,Ge=/([?&])_=[^&]*/,Ue=/^(.*?):[ \t]*([^\r\n]*)$/gm,
// #7653, #8125, #8152: local protocol detection
Ke=/^(?:about|app|app-storage|.+-extension|file|res|widget):$/,Qe=/^(?:GET|HEAD)$/,Ye=/^\/\//,
/* Prefilters
...
Je=st.createElement("a");Je.href=Me.href,_t.extend({
// Counter for holding the number of active queries
active:0,
// Last-Modified header cache for next request
lastModified:{},etag:{},ajaxSettings:{url:Me.href,type:"GET",isLocal:Ke.test(Me.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",
/*
		timeout: 0,
		data: null,
		dataType: null,
...
nt(nt(t,_t.ajaxSettings),e):
// Extending ajaxSettings
nt(_t.ajaxSettings,t)},ajaxPrefilter:tt(Ve),ajaxTransport:tt(Xe),
// Main method
ajax:function(t,e){
...
g.ifModified&&((l=_.getResponseHeader("Last-Modified"))&&(_t.lastModified[d]=l),(l=_.getResponseHeader("etag"))&&(_t.etag[d]=l)),
// if no content
204===t||"HEAD"===g.type?u="nocontent":304===t?u="notmodified":(u=a.state,r=a.data,o=!(s=a.error))):(
// Extract error from statusText and normalize for non-aborts
s=u,!t&&u||(u="error",t<0&&(t=0))),
// Set data for the fake xhr object
_.status=t,_.statusText=(e||u)+"",
// Success/Error
o?b.resolveWith(v,[r,u,_]):b.rejectWith(v,[_,u,s]),
// Status-dependent callbacks
_.statusCode(k),k=void 0,m&&y.trigger(o?"ajaxSuccess":"ajaxError",[_,g,o?r:s]),
// Complete
w.fireWith(v,[_,u]),m&&(y.trigger("ajaxComplete",[_,g]),
...
y=g.context&&(v.nodeType||v.jquery)?_t(v):_t.event,
// Deferreds
b=_t.Deferred(),w=_t.Callbacks("once memory"),
// Status-dependent callbacks
k=g.statusCode||{},
...
g.url=((t||g.url||Me.href)+"").replace(Ye,Me.protocol+"//"),
...
// Apply prefilters
et(Ve,g,e,_),p)return _;
// We can fire global events as of now if asked to
// Don't fire events if jQuery.event is undefined in an AMD-usage scenario (#15118)
// Check for headers option
for(r in
// Watch for a new set of requests
(m=_t.event&&g.global)&&0==_t.active++&&_t.event.trigger("ajaxStart"),
// Uppercase the type
...
!1===g.cache&&(d=d.replace(Ge,"$1"),s=(He.test(d)?"&":"?")+"_="+qe+++s),
// Put hash and anti-cache on the URL that will be requested (gh-1732)
g.url=d+s),
// Set the If-Modified-Since and/or If-None-Match header, if in ifModified mode.
g.ifModified&&(_t.lastModified[d]&&_.setRequestHeader("If-Modified-Since",_t.lastModified[d]),_t.etag[d]&&_.setRequestHeader("If-None-Match",_t.etag[d])),
// Set the correct header, if data is being sent
(g.data&&g.hasContent&&!1!==g.contentType||e.contentType)&&_.setRequestHeader("Content-Type",g.contentType),
// Set the Accepts header for the server, depending on the dataType
_.setRequestHeader("Accept",g.dataTypes[0]&&g.accepts[g.dataTypes[0]]?g.accepts[g.dataTypes[0]]+("*"!==g.dataTypes[0]?", "+Ze+"; q=0.01":""):g.accepts["*"]),g.headers)_.setRequestHeader(r,g.headers[r]);
// Allow custom headers/mimetypes and early abort
if(g.beforeSend&&(!1===g.beforeSend.call(v,_,g)||p))
...
w.add(g.complete),_.done(g.success),_.fail(g.error),
// Get transport
c=et(Xe,g,e,_)){
// If request was aborted inside ajaxSend, stop there
if(_.readyState=1,
// Send global event
m&&y.trigger("ajaxSend",[_,g]),p)return _;
// Timeout
g.async&&0<g.timeout&&(h=j.setTimeout(function(){_.abort("timeout")},g.timeout));try{p=!1,c.send(a,n)}catch(t){
// Rethrow post-completion exceptions
if(p)throw t;
// Propagate others as results
n(-1,t)}}else n(-1,"No Transport");return _},getJSON:function(t,e,n){return _t.get(t,e,n,"json")},getScript:function(t,e){return _t.get(t,void 0,e,"script")}}),_t.each(["get","post"],function(t,o){_t[o]=function(t,e,n,i){
// The url can be an options object (which then must have .url)
// Shift arguments if data argument was omitted
return yt(e)&&(i=i||n,n=e,e=void 0),_t.ajax(_t.extend({url:t,type:o,dataType:i,data:e,success:n},_t.isPlainObject(t)&&t))}}),_t._evalUrl=function(t){return _t.ajax({url:t,
// Make this explicit, since user can override this through ajaxSetup (#11264)
type:"GET",dataType:"script",cache:!0,async:!1,global:!1,throws:!0})},_t.fn.extend({wrapAll:function(t){var e;return this[0]&&(yt(t)&&(t=t.call(this[0])),
// The elements to wrap the target around
e=_t(t,this[0].ownerDocument).eq(0).clone(!0),this[0].parentNode&&e.insertBefore(this[0]),e.map(function(){for(var t=this;t.firstElementChild;)t=t.firstElementChild;return t}).append(this)),this},wrapInner:function(n){return yt(n)?this.each(function(t){_t(this).wrapInner(n.call(this,t))}):this.each(function(){var t=_t(this),e=t.contents();e.length?e.wrapAll(n):t.append(n)})},wrap:function(e){var n=yt(e);return this.each(function(t){_t(this).wrapAll(n?e.call(this,t):e)})},unwrap:function(t){return this.parent(t).not("body").each(function(){_t(this).replaceWith(this.childNodes)}),this}}),_t.expr.pseudos.hidden=function(t){return!_t.expr.pseudos.visible(t)},_t.expr.pseudos.visible=function(t){return!!(t.offsetWidth||t.offsetHeight||t.getClientRects().length)},_t.ajaxSettings.xhr=function(){try{return new j.XMLHttpRequest}catch(t){}};var tn={
// File protocol always yields status code 0, assume 200
0:200,
// Support: IE <=9 only
// #1450: sometimes IE returns 1223 when it should be 204
1223:204},en=_t.ajaxSettings.xhr();vt.cors=!!en&&"withCredentials"in en,vt.ajax=en=!!en,_t.ajaxTransport(function(o){var r,s;
...
_t.ajaxPrefilter(function(t){t.crossDomain&&(t.contents.script=!1)}),
// Install script dataType
_t.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/\b(?:java|ecma)script\b/},converters:{"text script":function(t){return _t.globalEval(t),t}}}),
// Handle cache's special case and crossDomain
_t.ajaxPrefilter("script",function(t){void 0===t.cache&&(t.cache=!1),t.crossDomain&&(t.type="GET")}),
// Bind script tag hack transport
_t.ajaxTransport("script",function(n){var i,o;
// This transport only deals with cross domain requests
if(n.crossDomain)return{send:function(t,e){i=_t("<script>").prop({charset:n.scriptCharset,src:n.url}).on("load error",o=function(t){i.remove(),o=null,t&&e("error"===t.type?404:200,t.type)}),
// Use native DOM manipulation to avoid our domManip AJAX trickery
st.head.appendChild(i[0])},abort:function(){o&&o()}}});var nn=[],on=/(=)\?(?=&|$)|\?\?/,rn;
// Default jsonp settings
_t.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var t=nn.pop()||_t.expando+"_"+qe++;return this[t]=!0,t}}),
// Detect, normalize options and install callbacks for jsonp requests
_t.ajaxPrefilter("json jsonp",function(t,e,n){var i,o,r,s=!1!==t.jsonp&&(on.test(t.url)?"url":"string"==typeof t.data&&0===(t.contentType||"").indexOf("application/x-www-form-urlencoded")&&on.test(t.data)&&"data");
...
t.converters["script json"]=function(){return r||_t.error(i+" was not called"),r[0]},
// Force json dataType
t.dataTypes[0]="json",
// Install callback
o=j[i],j[i]=function(){r=arguments},
// Clean-up function (fires after converters)
n.always(function(){
// If previous value didn't exist - remove it
void 0===o?_t(j).removeProp(i):j[i]=o,
// Save back as free
t[i]&&(
...
_t.parseHTML=function(t,e,n){return"string"!=typeof t?[]:(
// Single tag
...
i=(e=st.implementation.createHTMLDocument("")).createElement("base")).href=st.location.href,e.head.appendChild(i)):e=st),r=!n&&[],(o=Tt.exec(t))?[e.createElement(o[1])]:(o=_([t],e,r),r&&r.length&&_t(r).remove(),_t.merge([],o.childNodes)));var i,o,r},
/**
 * Load a url into a page
 */
_t.fn.load=function(t,e,n){var i,o,r,s=this,a=t.indexOf(" ");return-1<a&&(i=V(t.slice(a)),t=t.slice(0,a)),
// If it's a function
yt(e)?(
// We assume that it's the callback
n=e,e=void 0):e&&"object"==typeof e&&(o="POST"),
// If we have elements to modify, make the request
0<s.length&&_t.ajax({url:t,
...
_t("<div>").append(_t.parseHTML(t)).find(i):
// Otherwise use the full result
t)}).always(n&&function(t,e){s.each(function(){n.apply(this,r||[t.responseText,e,t])})}),this},
// Attach a bunch of functions for handling common AJAX events
_t.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(t,e){_t.fn[e]=function(t){return this.on(e,t)}}),_t.expr.pseudos.animated=function(e){return _t.grep(_t.timers,function(t){return e===t.elem}).length},_t.offset={setOffset:function(t,e,n){var i,o,r,s,a,l,u,c=_t.css(t,"position"),d=_t(t),f={};
// Set position first, in-case top/left are set even on static elem
"static"===c&&(t.style.position="relative"),a=d.offset(),r=_t.css(t,"top"),l=_t.css(t,"left"),
...
e=e.call(t,n,_t.extend({},a))),null!=e.top&&(f.top=e.top-a.top+s),null!=e.left&&(f.left=e.left-a.left+o),"using"in e?e.using.call(t,f):d.css(f)}},_t.fn.extend({
// offset() relates an element's border box to the document origin
offset:function(e){
// Preserve chaining for setter
if(arguments.length)return void 0===e?this:this.each(function(t){_t.offset.setOffset(this,e,t)});var t,n,i=this[0];return i?
...
n=i.ownerDocument,t=i.offsetParent||n.documentElement;t&&(t===n.body||t===n.documentElement)&&"static"===_t.css(t,"position");)t=t.parentNode;t&&t!==i&&1===t.nodeType&&(
// Incorporate borders into its offset, since they are outside its content origin
(o=_t(t).offset()).top+=_t.css(t,"borderTopWidth",!0),o.left+=_t.css(t,"borderLeftWidth",!0))}
// Subtract parent offsets and element margins
return{top:e.top-o.top-_t.css(i,"marginTop",!0),left:e.left-o.left-_t.css(i,"marginLeft",!0)}}},
...
offsetParent:function(){return this.map(function(){for(var t=this.offsetParent;t&&"static"===_t.css(t,"position");)t=t.offsetParent;return t||re})}}),
// Create scrollLeft and scrollTop methods
_t.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(e,o){var r="pageYOffset"===o;_t.fn[e]=function(t){return qt(this,function(t,e,n){
...
_t.each(["top","left"],function(t,n){_t.cssHooks[n]=M(vt.pixelPosition,function(t,e){if(e)
// If curCSS returns percentage, fallback to offset
return e=D(t,n),he.test(e)?_t(t).position()[n]+"px":e})}),
// Create innerHeight, innerWidth, height, width, outerHeight and outerWidth methods
_t.each({Height:"height",Width:"width"},function(s,a){_t.each({padding:"inner"+s,content:a,"":"outer"+s},function(i,r){
// Margin is only for outerHeight, outerWidth
_t.fn[r]=function(t,e){var n=arguments.length&&(i||"boolean"!=typeof t),o=i||(!0===t||!0===e?"margin":"border");return qt(this,function(t,e,n){var i;return bt(t)?0===r.indexOf("outer")?t["inner"+s]:t.document.documentElement["client"+s]:
...
_t.style(t,e,n,o)},a,n?t:void 0,n)}})}),_t.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "),function(t,n){
// Handle event binding
_t.fn[n]=function(t,e){return 0<arguments.length?this.on(n,null,t,e):this.trigger(n)}}),_t.fn.extend({hover:function(t,e){return this.mouseenter(t).mouseleave(e||t)}}),_t.fn.extend({bind:function(t,e,n){return this.on(t,null,e,n)},unbind:function(t,e){return this.off(t,null,e)},delegate:function(t,e,n,i){return this.on(e,t,n,i)},undelegate:function(t,e,n){
...
_t.proxy=function(t,e){var n,i,o;
...
(o=function(){return t.apply(e||this,i.concat(lt.call(arguments)))}).guid=t.guid=t.guid||_t.guid++,o},_t.holdReady=function(t){t?_t.readyWait++:_t.ready(!0)},_t.isArray=Array.isArray,_t.parseJSON=JSON.parse,_t.nodeName=u,_t.isFunction=yt,_t.isWindow=bt,_t.camelCase=h,_t.type=g,_t.now=Date.now,_t.isNumeric=function(t){
// As of jQuery 3.0, isNumeric is limited to
// strings and numbers (primitives or objects)
// that can be coerced to finite numbers (gh-2662)
var e=_t.type(t);return("number"===e||"string"===e)&&
...
/* harmony import */var _=n(/*! ../foundation.equalizer */"./js/foundation.equalizer.js");
/* harmony reexport (safe) */n.d(e,"Equalizer",function(){return _.Equalizer});
/* harmony import */var j=n(/*! ../foundation.interchange */"./js/foundation.interchange.js");
/* harmony reexport (safe) */n.d(e,"Interchange",function(){return j.Interchange});
/* harmony import */var x=n(/*! ../foundation.magellan */"./js/foundation.magellan.js");
/* harmony reexport (safe) */n.d(e,"Magellan",function(){return x.Magellan});
/* harmony import */var $=n(/*! ../foundation.offcanvas */"./js/foundation.offcanvas.js");
/* harmony reexport (safe) */n.d(e,"OffCanvas",function(){return $.OffCanvas});
...
/* harmony import */var M=n(/*! ../foundation.responsiveAccordionTabs */"./js/foundation.responsiveAccordionTabs.js");
/* harmony reexport (safe) */n.d(e,"ResponsiveAccordionTabs",function(){return M.ResponsiveAccordionTabs}),r.Foundation.addToJquery(o.a),// Add Foundation Utils to Foundation global namespace for backwards
// compatibility.
...
p.Touch.init(o.a),m.Triggers.init(o.a,r.Foundation),c.MediaQuery._init(),r.Foundation.plugin(g.Abide,"Abide"),r.Foundation.plugin(v.Accordion,"Accordion"),r.Foundation.plugin(y.AccordionMenu,"AccordionMenu"),r.Foundation.plugin(b.Drilldown,"Drilldown"),r.Foundation.plugin(w.Dropdown,"Dropdown"),r.Foundation.plugin(k.DropdownMenu,"DropdownMenu"),r.Foundation.plugin(_.Equalizer,"Equalizer"),r.Foundation.plugin(j.Interchange,"Interchange"),r.Foundation.plugin(x.Magellan,"Magellan"),r.Foundation.plugin($.OffCanvas,"OffCanvas"),r.Foundation.plugin(C.Orbit,"Orbit"),r.Foundation.plugin(O.ResponsiveMenu,"ResponsiveMenu"),r.Foundation.plugin(T.ResponsiveToggle,"ResponsiveToggle"),r.Foundation.plugin(S.Reveal,"Reveal"),r.Foundation.plugin(E.Slider,"Slider"),r.Foundation.plugin(z.SmoothScroll,"SmoothScroll"),r.Foundation.plugin(A.Sticky,"Sticky"),r.Foundation.plugin(P.Tabs,"Tabs"),r.Foundation.plugin(L.Toggler,"Toggler"),r.Foundation.plugin(D.Tooltip,"Tooltip"),r.Foundation.plugin(M.ResponsiveAccordionTabs,"ResponsiveAccordionTabs"),
...
/**
     ...
     */},{key:"down",value:function t(e){var n=this;
// If having multiple submenus active is disabled, close all the submenus
// that are not parents or children of the targeted submenu.
if(!this.options.multiOpen){
// The "branch" of the targetted submenu, from the component root to
// the active submenus nested in it.
var i=e.parentsUntil(this.$element).add(e).add(e.find(".is-active")),o=this.$element.find(".is-active").not(i);// All the active submenus that are not in the branch.
this.up(o)}e.addClass("is-active").attr({"aria-hidden":!1}),this.options.submenuToggle?e.prev(".submenu-toggle").attr({"aria-expanded":!0}):e.parent(".is-accordion-submenu-parent").attr({"aria-expanded":!0}),e.slideDown(this.options.slideSpeed,function(){
/**
...
/* harmony import */var i=n(/*! jquery */"jquery"),c=/* */n.n(i),o=n(/*! ./foundation.core.utils */"./js/foundation.core.utils.js"),d=n(/*! ./foundation.util.mediaQuery */"./js/foundation.util.mediaQuery.js"),r,f={version:"6.5.2",
/**
 ...
 */n.r(e),
/* harmony export (binding) */n.d(e,"Dropdown",function(){return k});
/* harmony import */var p=n(/*! jquery */"jquery"),m=/* */n.n(p),g=n(/*! ./foundation.util.keyboard */"./js/foundation.util.keyboard.js"),v=n(/*! ./foundation.core.utils */"./js/foundation.core.utils.js"),y=n(/*! ./foundation.positionable */"./js/foundation.positionable.js"),b=n(/*! ./foundation.util.triggers */"./js/foundation.util.triggers.js"),w=n(/*! ./foundation.util.touch */"./js/foundation.util.touch.js"),k=
/* */
 ...
 */n.r(e),
/* harmony export (binding) */n.d(e,"Reveal",function(){return k});
 ...
 * @requires foundation.util.keyboard
 * @requires foundation.util.touch
 */function j(t,e){return t/e}function w(t,e,n,i){return Math.abs(t.position()[e]+t[i]()/2-n)}function f(t,e){return Math.log(e)/Math.log(t)}
/***/n.r(e),
/* harmony export (binding) */n.d(e,"Slider",function(){return y});
/* harmony import */var h=n(/*! jquery */"jquery"),k=/* */n.n(h),p=n(/*! ./foundation.util.keyboard */"./js/foundation.util.keyboard.js"),x=n(/*! ./foundation.util.motion */"./js/foundation.util.motion.js"),_=n(/*! ./foundation.core.utils */"./js/foundation.core.utils.js"),m=n(/*! ./foundation.core.plugin */"./js/foundation.core.plugin.js"),g=n(/*! ./foundation.util.touch */"./js/foundation.util.touch.js"),v=n(/*! ./foundation.util.triggers */"./js/foundation.util.triggers.js"),y=
/* */
function(t){function i(){return o(this,i),a(this,u(i).apply(this,arguments))}return c(i,t),s(i,[{key:"_setup",
/**
...
/**
    ...
    */},{key:"_pctOfBar",value:function t(e){var n=j(e-this.options.start,this.options.end-this.options.start);switch(this.options.positionValueFunction){case"pow":n=this._logTransform(n);break;case"log":n=this._powTransform(n);break}return n.toFixed(2)}
/**
    * @function
    * @private
...
g=(100*j((h-f)*p,h)).toFixed(this.options.decimal);//fixing the decimal value for the location number, is passed to other methods as a fixed floating-point value
...
w=~~(100*j(f,h));//if left handle, the math is slightly different than if it's the right handle, and the left/top property needs to be changed for the fill bar
if(y)
...
var _=this.$element.data("dragging")?1e3/60:this.options.moveTime;Object(x.Move)(_,e,function(){
...
/**
     ...
     */},{key:"_setInitAttr",value:function t(e){var n=0===e?this.options.initialStart:this.options.initialEnd,i=this.inputs.eq(e).attr("id")||Object(_.GetYoDigits)(6,"slider");this.inputs.eq(e).attr({id:i,max:this.options.end,min:this.options.start,step:this.options.step}),this.inputs.eq(e).val(n),this.handles.eq(e).attr({role:"slider","aria-controls":i,"aria-valuemax":this.options.end,"aria-valuemin":this.options.start,"aria-valuenow":n,"aria-orientation":this.options.vertical?"vertical":"horizontal",tabindex:0})}
/**
...
e.preventDefault();var s=this,a=this.options.vertical,l=a?"height":"width",u=a?"top":"left",c=a?e.pageY:e.pageX,d=this.$handle[0].getBoundingClientRect()[l]/2,f=this.$element[0].getBoundingClientRect()[l],h=a?k()(window).scrollTop():k()(window).scrollLeft(),p=this.$element.offset()[u];// touch events emulated by the touch util give position relative to screen, add window.scroll to event coordinates...
// best way to guess this is simulated is if clientY == pageY
e.clientY===e.pageY&&(c+=h);var m=c-p,g,v=j(g=m<0?0:f<m?f:m,f),y,b;if(o=this._value(v),// turn everything around for RTL, yay math!
Object(_.rtl)()&&!this.options.vertical&&(o=this.options.end-o),o=s._adjustValue(null,o),//boolean flag for the setHandlePos fn, specifically for vertical sliders
...
/**
     ...
     * @private
     */},{key:"_events",value:function t(){this._linkClickListener=this._handleLinkClick.bind(this),this.$element.on("click.zf.smoothScroll",this._linkClickListener),this.$element.on("click.zf.smoothScroll",'a[href^="#"]',this._linkClickListener)}
/**
...
/**
     ...
     * @function
     */
value:function t(){this.$element.off("click.zf.smoothScroll",this._linkClickListener),this.$element.off("click.zf.smoothScroll",'a[href^="#"]',this._linkClickListener)}}],[{key:"scrollToLoc",
/**
     * Function to scroll to a given location on the page.
     * @param {String} loc - A properly formatted jQuery id selector. Example: '#foo'
...
o.each(function(){var t=u()(this),e=t.children("ul");e.length&&(t.addClass(a),l&&(t.attr({"aria-haspopup":!0,"aria-label":t.children("a:first").text()}),// Note:  Drilldowns behave differently in how they hide, and so need
...
/* harmony import */var d=n(/*! jquery */"jquery"),f=/* */n.n(d),h={},p,m,g,v,y,b=!1,w=!1,k=
/* */
...
// event buffer timer
var o=null,d=["input","select","textarea"],r=[],f=[16,// shift
17,// control
18,// alt
...
p[$()]="mouse",v(),b("input"),b("intent")},v=function t(){
...
// touch events
"ontouchstart"in window&&(window.addEventListener("touchstart",j,e),window.addEventListener("touchend",y))),
// mouse wheel
window.addEventListener($(),w,e),
// keyboard events
window.addEventListener("keydown",j),window.addEventListener("keyup",j),
// focus events
window.addEventListener("focusin",k),window.addEventListener("focusout",_)},y=function t(e){
// only execute if the event buffer timer isn't running
if(!m){var n=e.which,i=p[e.type];"pointer"===i&&(i=x(e));var o=!h.length&&-1===f.indexOf(n),r=h.length&&-1!==h.indexOf(n),s="keyboard"===i&&n&&(o||r)||"mouse"===i||"touch"===i;if(u!==i&&s){u=i;try{window.sessionStorage.setItem("what-input",u)}catch(t){}b("input")}if(c!==i&&s){
// preserve intent for keyboard typing in form fields
var a=document.activeElement,l;if(a&&a.nodeName&&-1===d.indexOf(a.nodeName.toLowerCase())){c=i;try{window.sessionStorage.setItem("what-intent",c)}catch(t){}b("intent")}}}},b=function t(e){n.setAttribute("data-what"+e,"input"===e?u:c),C(e)},w=function t(e){
// only execute if the event buffer timer isn't running
// or scrolling isn't happening
if(
// test to see if `mousemove` happened relative to the screen to detect scrolling versus mousemove
T(e),!m&&!s){var n=p[e.type];if("pointer"===n&&(n=x(e)),c!==n){c=n;try{window.sessionStorage.setItem("what-intent",c)}catch(t){}b("intent")}}},k=function t(e){e.target.nodeName?(i=e.target.nodeName.toLowerCase(),n.setAttribute("data-whatelement",i),e.target.classList&&e.target.classList.length&&n.setAttribute("data-whatclasses",e.target.classList.toString().replace(" ",","))):
// If nodeName is undefined, clear the element
// This can happen if click inside an <svg> element.
_()},_=function t(){i=null,n.removeAttribute("data-whatelement"),n.removeAttribute("data-whatclasses")},j=function t(e){
...
m=!1},100)},x=function t(e){return"number"==typeof e.pointerType?l[e.pointerType]:"pen"===e.pointerType?"touch":e.pointerType},$=function t(){var e=void 0;
...
// 4. Animations
// -------------
var e;t(),new Swup({plugins:[swupGaPlugin],animationSelector:'[class*="swup-transition-"]',elements:["#main"]}).on("contentReplaced",function(){t()})});